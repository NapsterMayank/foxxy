export function StudentIllustration() {
  return (
    <svg className="h-28 w-28" viewBox="0 0 120 120" fill="none" role="presentation">
      ...
      <path d="m27 76 33 11 33-11v12L60 99 27 88V76Z" fill="currentColor" />
      <path d="m20 69 40-14 40 14-40 14-40-14Z" fill="currentColor" opacity="0.72" />
    </svg>
  );
}
...
export function ParentIllustration() {
  return (
    <svg className="h-28 w-28" viewBox="0 0 120 120" fill="none" role="presentation">
      ...
      <path d="M20 91c2-22 11-34 25-34 15 0 24 12 26 34H20Z" fill="currentColor" opacity="0.72" />
      <path d="M59 91c1-18 8-28 19-28 12 0 20 10 22 28H59Z" fill="currentColor" />
    </svg>
  );
}
