/**
 * Copies the backend's wire contracts into `src/lib/api/generated/`.
 *
 * ===========================================================================
...
const backendShared = resolve(frontendRoot, '..', 'backend', 'src', 'shared');
...
const outRoot = join(frontendRoot, 'src', 'lib', 'api', 'generated');
